...
// Metal-specific platform plugin, registered as a singleton via module
// initializer. Pure C++ — Obj-C types are not exposed in this header so it
// can be included from non-`.mm` translation units.
